...
const FeedItem = ({avatar, content, displayName, image, image2, timestamp, username,}) => {
    return (
        <article className="flex space-x-3 border-b border-gray-extraLight px-4 py-3 cursor-pointer">
            ...
            {timestamp?.toDate().toLocaleTimeString("tr-TR")}
                ...
                {image2 && <img src="https://i.gifer.com/FXi0.gif" className="my-2 rounded-xl max-h-96" />}
                <ul className="-ml-1 mt-3 flex justify-between max-w-md">
                    <li className="flex items-center  space-x-3 text-gray-dark text-sm group">
                        ...
                        <span className="group-hover:text-primary-base">3</span>
                    </li>
                    ...
                    <li className="flex items-center  space-x-3 text-gray-dark text-sm group">
                        ...
                        <span className="group-hover:text-pink-400">3</span>
                    </li>
